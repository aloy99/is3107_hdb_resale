...
def migration_tasks():
    ...
    create_pg_warehouse_schema >> [create_int_mrts, create_int_nearest_mrts, create_int_resale_price, create_int_parks, create_int_nearest_park, create_int_pri_schools, create_int_nearest_pri_schools] 
