...
@dag(dag_id='daily_hdb_pipeline', default_args=default_args, schedule=None, catchup=False, tags=['main_dag'], template_searchpath=["/opt/airflow/"])
def daily_hdb_pipeline():
    ...
    # Pipeline order
    scrape_resale_prices_>> enhance_resale_price_coords_ >> get_mrts_within_2km_ >> get_dist_from_cbd_
    get_dist_from_cbd_ >> generate_report_

daily_hdb_pipeline_dag = daily_hdb_pipeline()
